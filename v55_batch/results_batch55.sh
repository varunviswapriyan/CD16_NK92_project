#!/bin/bash
# results_batch55.sh
#   bash results_batch55.sh                    -> residues + params for v55..v64
#   bash results_batch55.sh plot 56 58 62      -> run check_fit.py on chosen versions, copy plots to ~/plot_vNN.png
...
echo "Next: bash $(dirname $0)/results_batch55.sh plot 56 58 60 62   ('Largest single-point miss' + point-by-point lines are the diagnostic)"
