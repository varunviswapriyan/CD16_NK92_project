...
#5. PSO
    ...
    lb=[5.0,  -1.0,   -4.0,  +1.7] #lower bounds for C1,C2,g, A0_zeta, A0_mixed, A0_gamma
    ub=[6.0,   1.0,   -1.0,  +3.0] #upper bounds for C1,C2,g, A0_zeta, A0_mixed, A0_gamma, ZAP0


    optimizer = GlobalBestPSO(n_particles=number_of_paricles, dimensions=4, options={'c1': 1.5, 'c2': 1.5, 'w': 0.5}, bounds=(lb, ub))
    ...
    f3.write(str(optimized_param[0])+"\t"+str(optimized_param[1])+"\t"+str(optimized_param[2])+"\t"+str(optimized_param[3])+"\n")
    thlock.release() #lock off
