...
#5. PSO
    ...
    lb=[5.0,  -1.0,   -4.0,  +1.0, +1.0, +1.0] #lower bounds for C1,C2,g, A0_zeta, A0_mixed, A0_gamma
    ub=[6.0,   1.0,   -1.0,  +2.3, +2.3, +2.3] #upper bounds for C1,C2,g, A0_zeta, A0_mixed, A0_gamma, ZAP0
    ...
    f3.write(str(optimized_param[0])+"\t"+str(optimized_param[1])+"\t"+str(optimized_param[2])+"\t"+str(optimized_param[3])+"\t"+str(optimized_param[4])+"\t"+str(optimized_param[5])+"\n")
    thlock.release() #lock off
