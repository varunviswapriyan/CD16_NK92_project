...
#5. PSO
    ...
    # parameter bounds [K1, K2, C1,C2,g, A0_zeta, A0_mixed, A0_gamma, ZAP0, SYK0]
    lb=[-4.0, -2.0,    4.0,   0.0,   -4.0,  +1.0, +1.0, +1.0, +2.5, +2.5] #lower bounds for K1, K2, C1,C2,g, A0_zeta, A0_mixed, A0_gamma, ZAP0, SYK0
    ub=[ 0.0,  0.0,    6.0,   1.0,   -1.0,  +2.0, +2.0, +2.0, +3.2, +3.2] #upper bounds for K1, K2, C1,C2,g, A0_zeta, A0_mixed, A0_gamma, ZAP0, SYK0


    optimizer = GlobalBestPSO(n_particles=number_of_paricles, dimensions=10, options={'c1': 1.5, 'c2': 1.5, 'w': 0.5}, bounds=(lb, ub))
