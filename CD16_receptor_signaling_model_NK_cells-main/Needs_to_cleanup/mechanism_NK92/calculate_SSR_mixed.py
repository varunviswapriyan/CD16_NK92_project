...
def mixed_PZAP(n,K1,K2,a0,ZAP0,SYK0,dir_name):


    p=6 # which column index which obseravable in bionetgen file for total ZAP70
    p1=11 # which column index which obseravable in bionetgen file for total SYK

    N=2000 #Ca signal time points and SSR at N timepoints
    
    tstart=0.0 # Fit to be start from which timepoint : interpolation of pZAP70 signal starts at 25 sec
    ...
    dir_name = "mixed_runs/" + str(dir_name)
    model = bionetgen.bngmodel("JJ_mixed_0_July7.bngl")
